...
setThinkTime 0.01
ssh $vmssh "./Desktop/brownout-rubis-icse2014/PHP/attrLocalController.py --pole $pole --serviceLevel $serviceLevel --cap $cap --concurrency $concurrency --thinktime $thinktime --preference $preference --w0 $w0 --w1 $w1 --w2 $w2" &> lc.log
